            ...
            <div class="card-body">
                <form action="{{ route('laporan.cetakpresensi') }}" method="POST" target="_blank" id="formPresensi">
                    ...
                    <div class="form-group mb-3">
                        <select name="kode_cabang" id="kode_cabang_presensi"
                            class="form-select select2Kodecabangpresensi">
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-12 col-sm-12">
                            <button type="submit" name="submitButton" class="btn btn-primary w-100 mb-2"
                                id="submitButton">
            ...
            $.ajax({
                ...
                success: function(respond) {
                    ...
                    respond.forEach(function(item) {
                        $("#nik_presensi").append("<option value='" + item.nik +
                            "'>" + item.nik + " - " + item
                            .nama_karyawan +
                            "</option>");
                    });

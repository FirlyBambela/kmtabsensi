                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <img src="{{ asset('assets/img/illustrations/karyawan1.png') }}" height="70"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <img src="{{ asset('assets/img/illustrations/karyawan2.webp') }}" height="70"
                                    alt="view sales" class="me-3">
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <img src="{{ asset('assets/img/illustrations/karyawan3.png') }}" height="70"
                                    alt="view sales" class="me-3">
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <img src="{{ asset('assets/img/illustrations/karyawan4.webp') }}" height="70"
                                    alt="view sales" class="me-3">
                            </div>
                        </div>
                    </div>

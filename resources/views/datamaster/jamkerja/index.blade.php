                        ...
                        <form action="{{ route('jamkerja.index') }}">
                            <div class="row">
                                <div class="col-lg-10 col-sm-12 col-md-12">
                                    <x-input-with-icon label="Cari Nama Jam Kerja"
                                        value="{{ Request('nama_jam_kerja_search') }}" name="nama_jam_kerja_search"
                                        icon="ti ti-search" />
                                </div>
                                ...
                                <tbody>
                                    @foreach ($jamkerja as $d)
                                        <tr>
                                            ...
                                            <td>{{ $d->jam_awal_istirahat != null ? date('H:i', strtotime($d->jam_akhir_istirahat)) : '-' }}
                                            </td>
                                            <td>{{ $d->jam_akhir_istirahat != null ? date('H:i', strtotime($d->jam_akhir_istirahat)) : '-' }}
                                            </td>
                                            <td>
                                                @if ($d->lintashari == 1)
                                                    <i class="ti ti-checks text-success"></i>

    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                @can('karyawan.create')
                    <a href="#" class="btn btn-primary mb-2" id="btnCreate"><i class="fa fa-plus me-2"></i> Tambah
                        Karyawan</a>
                    <a href="#" class="btn btn-success mb-2" id="btnImport"><i class="ti ti-file-import me-2"></i>
                        Import
                        Excel</a>
                @endcan
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($d->lock_location == '1')
                                                    <a
                                                        href="{{ route('karyawan.lockunlocklocation', Crypt::encrypt($d->nik)) }}">
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($d->lock_jam_kerja == '1')
                                                    <a
                                                        href="{{ route('karyawan.lockunlockjamkerja', Crypt::encrypt($d->nik)) }}">
                                                        <i class="ti ti-lock text-success"></i>
                                                    </a>
                                                @else
                                                    <a
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    @can('users.create')
                                                        @if (empty($d->id_user))
                                                            <a
                                                                href="{{ route('karyawan.createuser', Crypt::encrypt($d->nik)) }}">
                                                                <i class="ti ti-user-plus text-danger"></i>
                                                            </a>
                                                        @else
                                                            <a
                                                                href="{{ route('karyawan.deleteuser', Crypt::encrypt($d->nik)) }}">
